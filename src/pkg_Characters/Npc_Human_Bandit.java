 ...
 * @author VERESG
 */
public class Npc_Human_Bandit extends Npc_Human{
    
    
    public Npc_Human_Bandit(String fname, String race, String cast, Weapons weapon, String shout, int max_health){
