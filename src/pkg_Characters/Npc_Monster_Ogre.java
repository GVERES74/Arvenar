 ...
 * @author VERESG
 */
public class Npc_Monster_Ogre extends Npc_Monster{
    
     public Npc_Monster_Ogre(String fname, String race, String cast, Weapons weapon, String shout, int max_health){
